...
PAGES = {
    ...
    "🤖 Modelling & Prediction": "prediction"
}
...
# ==============================================================================
elif selection == "🤖 Modelling & Prediction":
    st.header("🤖 PM2.5 Prediction (XGBoost Regressor)")
    ...
    try:
        ...
        if st.button("Predict PM2.5"):
            ...
            try:
                ...
                st.markdown(f"### Predicted PM2.5: <span style='color:#3366CC; font-size: 32px;'>{prediction:.2f} µg/m³</span>", unsafe_allow_html=True)

...
Original file is located at
    https://colab.research.google.com/drive/1wIo8rD-Ma1aneOEB8RoN42VhU2rrLxBX
"""
...
# ==========================================
if page == "Home":
    st.title("☁️ Air Quality Index (AQI) Analytics")
    ...
    with col1:
        ...
        **Key Features:**
        ...
        - 🤖 **AI Prediction:** Real-time pollutant forecasting.
        - 📈 **Trend Analysis:** Seasonal and yearly breakdown.
        """)
...
# ==========================================
    ...
    if not selected_cities:
        ...
        # 1. Time Series Plot
        st.subheader(f"📅 {pollutant} Trends Over Time")
...
# ==========================================
    ...
    if st.button("Train XGBoost Model"):
        with st.spinner("Training Model... Please wait..."):
            # Data Prep
            target = 'PM2.5'
            features = ['PM10', 'NO2', 'CO', 'SO2', 'O3'] # REMOVED AQI TO PREVENT LEAKAGE
...
# ==========================================
    ...
    if 'model' not in st.session_state:
        st.warning("⚠️ Please train the model in the 'Model Evaluation' page first!")
    else:

...
!echo "City,Date,PM2.5,PM10,NO2,CO,SO2,O3" > data/india_air_quality.csv
!echo "Delhi,2023-01-01,150,200,80,5,30,45" >> data/india_air_quality.csv
!echo "Mumbai,2023-01-01,70,120,50,2,15,35" >> data/india_air_quality.csv
!echo "Chennai,2023-01-01,40,60,20,1,10,25" >> data/india_air_quality.csv
!echo "Kolkata,2023-01-01,180,250,90,7,40,55" >> data/india_air_quality.csv
!echo "Bangalore,2023-01-01,60,100,45,3,20,30" >> data/india_air_quality.csv
...
st.title("🌍 Air Quality Forecasting & Analysis Platform")
st.markdown("""
...
@st.cache_data
def load_data():
    return pd.read_csv("data/india_air_quality.csv")
...
df = pd.read_csv("data/india_air_quality.csv")
